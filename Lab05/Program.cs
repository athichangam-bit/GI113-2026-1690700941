...
namespace Lab05
{
    internal class Program
    {
        ...
        {
            //อ่านค่าเริ่มต้น 6 ค่าด้วย TryParse แล้วแสดงสถานะเริ่มเกม
            ...
            //ดื่มยา แล้วคำนวณดาเมจ 3 แบบ(ยังไม่โจมตีจริง แค่ดูตัวเลข)
            ...
            //คริติคอลฮิต (จุดเดียวในทั้งแล็บที่ใช้ Random)!!!!!!!!
